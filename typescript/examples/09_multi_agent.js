...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, authority, authorization, intent, policy, transaction, execution, trustRecord, evidence, _i, _a, _b, name_1, value, receipt, error_1;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    trustRecord = {
                        ...
                        verifications: [],
                        receipts: [],
                        trustRecordHash: "9ef40fbc06e94c56a5bc11d2d0d89ef1",
                        createdAt: new Date(),
                        updatedAt: new Date(),
                    };
                    console.log();
                    ...
                    console.log("------------------------------");
                    console.log("Organization :", authority.authorityName);
                    console.log("Workflow     :", intent.operation);
                    ...
                    for (_i = 0, _a = Object.entries(evidence); _i < _a.length; _i++) {
                        _b = _a[_i], name_1 = _b[0], value = _b[1];
                        console.log("".concat(name_1.padEnd(12), " : ").concat(value.agent));
                        console.log("Result        : ".concat(value.result));
                        console.log();
                    }
                    ...
                    console.log();
                    console.log("Submitting workflow to Parmana Runtime...");
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                ...
                case 4:
                    ...
                    console.log("✓ Execution Trust Record");
                    console.log();
                    console.log("Parmana does not orchestrate AI agents.");
                    console.log("It governs the execution of the shared");
                    console.log("workflow by recording a single immutable");
                    console.log("Execution Trust Record that spans every");
                    console.log("participating agent.");
                    console.log();
