        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    execution = {
                        ...
                        decision: {
                            ...
                            reason: "All driving policy conditions satisfied.",
                    ...
                    trustRecord = {
                        ...
                        verifications: [],
                        receipts: [],
                        trustRecordHash: "a1f94b0c6d5a4d7280bb59b7d41d9012",
                        createdAt: new Date(),
                        updatedAt: new Date(),
                    };
                    console.log();
                    ...
                    console.log("Vehicle");
                    console.log("------------------------------");
                    console.log("Vehicle       :", authorization.subject);
                    console.log("Destination   :", intent.target);
                    console.log();
                    console.log("Policy");
                    console.log("------------------------------");
                    ...
                    console.log("Evidence      :", execution.evidence);
                    console.log();
                    ...
                    console.log();
                    console.log("Submitting execution to Parmana Runtime...");
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 4:
                    ...
                    console.log("✓ Execution Trust Record");
                    console.log();
                    console.log("The autonomous vehicle remains independently");
                    console.log("verifiable because every execution artifact");
                    console.log("is recorded as part of the immutable");
                    console.log("Execution Trust Record.");
                    console.log();
