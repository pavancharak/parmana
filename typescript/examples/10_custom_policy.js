        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    execution = {
                        ...
                        decision: {
                            ...
                            reason: "Production policy v2.3.1 approved execution.",
                    ...
                    trustRecord = {
                        ...
                        verifications: [],
                        receipts: [],
                        trustRecordHash: "91c84e64b42b4fa89b2df6f7a37fd0d5",
                        createdAt: new Date(),
                        updatedAt: new Date(),
                    };
                    console.log();
                ...
                case 4:
                    ...
                    console.log("------------------------------");
                    console.log("BusinessTransaction specifies the PolicyReference.");
                    console.log("The Runtime loads exactly one policy version.");
                    console.log("The Runtime never discovers or selects policies.");
                    console.log("Deterministic replay always evaluates");
                    console.log("the same policy version.");
                    console.log();
