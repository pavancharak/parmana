...
receipts:
  ...
  async appendExecution(
    ...
    if (error) {
      ...
      throw new Error(
        `Failed to append Execution: ${error.message}`
      );
  ...
  async replaceExecution(
    ...
    throw new Error(
      "replaceExecution() is deprecated. Use appendExecution()."
    );
  ...
  async appendOverride(
    ...
    if (error) {
      ...
      throw new Error(
        `Failed to append Override: ${error.message}`
      );
  ...
  async appendVerification(
    ...
    if (error) {
      ...
      throw new Error(
        `Failed to append Verification: ${error.message}`
      );
  ...
  async appendReceipt(
    ...
    if (error) {
      ...
      throw new Error(
        `Failed to append Receipt: ${error.message}`
      );
...
> {
  ...
  return (data ?? []).map(
    (row) =>
      row.execution_json as Execution
  );
...
return (data ?? []).map(
  (row) =>
    row.verification_json as Verification
);
